...
final Map<String, String> itemVideoLinks = {
  'Crunches': 'https://drive.google.com/uc?export=download&id=1GlH-FHP03YUsacpno7ts77NK0RtEkBvO',
  'Leg Raises': 'https://drive.google.com/uc?export=download&id=195WnwgDFdP9ASQKoSfnvU_jRkVYpZwAa',
  'Russian Twists': 'https://drive.google.com/uc?export=download&id=1ji-baAoZgClJDTOAQ0Z_ybbuRUjJllvK',
  'Plank': 'https://drive.google.com/uc?export=download&id=1XheSUCCTeLhIgqEeT0pgxf--9MeRPjnj',
  'Mountain Climber': 'https://drive.google.com/uc?export=download&id=1T6C8ohumxyBchXnPNT5JtJKHU8Bl-FQS',
  'Dumbbells Press': 'https://drive.google.com/uc?export=download&id=1aVnUQt6RdfIb7anwJ8S1npiYkshjMNX7',
  'Lateral Raises': 'https://drive.google.com/uc?export=download&id=1ONNtCLtiF4CqYy49atvBMrbAlmC1MShz',
  'Front Raises': 'https://drive.google.com/uc?export=download&id=1efSBFJ0TTf4BiLGzfiGC7rfGqIMjqsh5',
  'Rear Delt Fly': 'https://drive.google.com/uc?export=download&id=14yNlEQzypqbzBe1reE1CwAhrAu8vZZgJ',
  'Upright Rows': 'https://drive.google.com/uc?export=download&id=1u0ArMKZ2a70k9D2CKLU8gPx5WYQofU39',
  'Barbell Curl': 'https://drive.google.com/uc?export=download&id=d/1hlmhduf-tP0cDB2ZlDIsllUoMRkOxyDE',
  'Dumbbell Curl': 'https://drive.google.com/uc?export=download&id=1liTcydG-57qCRfjDE4WpzTPOmQOeBBqy',
  'Hammer Curl': 'https://drive.google.com/uc?export=download&id=1yF9WktY2-4U5QSQU6i9kLC7kgBi6R-84',
  'Preacher Curl': 'https://drive.google.com/uc?export=download&id=1hmSOEbYyIm2UPv5jhPoo3YlzSSZuDjpN',
  'Incline Curl': 'https://drive.google.com/uc?export=download&id=1AUSxRok1lc0dUFbXiPGBUuAGRfq0vlIB',
  'Incline Bench Press': 'https://drive.google.com/uc?export=download&id=1L4fR4ZHH5iRxkG8SXvcRQHRKzJ3L3t0C',
  'Flat Bench Press': 'https://drive.google.com/uc?export=download&id=1VN8-MIimpoN2FrD6nULYsXhvB8KqNLgs',
  'Decline Bench Press': 'https://drive.google.com/uc?export=download&id=1Sx-YbfNK_uJMT_-tfjO8ly6T8XyarwvV',
  'Chest Dips': 'https://drive.google.com/uc?export=download&id=16iasnBhv56Wbd_EGfae784R_30b6VAzv',
  'Fly Machine': 'https://drive.google.com/uc?export=download&id=1nRsdX8w-XdRFw-TVO_gDJ7fbfSD1QJh1',
  'Triceps Dips': 'https://drive.google.com/uc?export=download&id=1M2i8ku3wB6Z0luo3049ptxq6PFubmjTz',
  'Overhead Dumbbell': 'https://drive.google.com/uc?export=download&id=1v577nTbTkNe1F0Cee3IFzGI8lnMVHPNR',
  'Triceps PushDown': 'https://drive.google.com/uc?export=download&id=1J9PcXcdG7oGuwYTmzksTp6Cy_GL4lBYk',
  'Close-Grip Bench Press': 'https://drive.google.com/uc?export=download&id=1-gmPKt1pmmlpfb5nX0A8RMEkWF9sIz6d',
  'Skull Crushers': 'https://drive.google.com/uc?export=download&id=1-VRtQ_CXuxRnCyU4QECO4ZJEp9QQ5np7',
  'Pull-ups': 'https://drive.google.com/uc?export=download&id=1l1_IlIbNCikGKbGZsUvrWZaOTV5nDAwC',
  'Lat Pulldowns': 'https://drive.google.com/uc?export=download&id=1Omk5lnr6CE8fV53MoYpF5r11qgHuFJBG',
  'Bent Over Rows': 'https://drive.google.com/uc?export=download&id=1KtFZBGHpcBuD3kp1RkPkgc8AWQZU7wVh',
  'Seated Cable Rows': 'https://drive.google.com/uc?export=download&id=1cfl7xBN3pLgLdbmVBlfBPKXjcPO4QAB8',
  'Deadlifts': 'https://drive.google.com/uc?export=download&id=1IZRnD3UiXPMqOCkccbPn5rA3NunjUAnl',
  'Squats': 'https://drive.google.com/uc?export=download&id=10zjtjrAz87Ty9SPiTAGB7Sa50Yq9gmmC',
  'Leg Press': 'https://drive.google.com/uc?export=download&id=1LTMk_nmd0woPDIL4XGwAyGZoREfQced-',
  'Walking Lunges': 'https://drive.google.com/uc?export=download&id=1oP-LIFGa7ow1X6426G17X71B-ZMhb024',
  'Leg Curls': 'https://drive.google.com/uc?export=download&id=1XOKKYerKclhxWOWIP95ISOIHDljqmUbg',
  'Treadmill Running': 'https://drive.google.com/uc?export=download&id=14-A5L-oHkgc0R5GXn6OIgScbSmAv6x_a',
  'Stationary Bike': 'https://drive.google.com/uc?export=download&id=1L6TOvWiqIWziSbjKs5GY4eM60zR5ZotK',
  'Rowing Machine': 'https://drive.google.com/uc?export=download&id=1BO10ptVpCl474blxn_bjxqKLa679jlQj',
  'Elliptical Trainer': 'https://drive.google.com/uc?export=download&id=1BO10ptVpCl474blxn_bjxqKLa679jlQj',
  'Standing Calf Raises': 'https://drive.google.com/uc?export=download&id=1J82SJ7HMbLfGH5chSb3gF3AOUJSnYaqE',
  'Seated Calf Raises': 'https://drive.google.com/uc?export=download&id=1Fz-F2rvzR6RssELHd0xhTZWNTPLyCLdh',
  'Calf Press': 'https://drive.google.com/uc?export=download&id=1H_TxOD6TQCY8LJW8MRr3QG151LHVKfdf',
  'Box Jump': 'https://drive.google.com/uc?export=download&id=1MQtrNe5phvXDzgX-0PKXLSfE3Rx7oX42',
};
...
final Map<String, String> itemSetRoutineTime = {
  ...
  'Mountain Climber': ' 3-4 sets of 20-30 seconds (as a timed interval) or 10-15 reps per leg for each set.',
  ...
  'Treadmill Running': '20-30 minutes of continuous jogging or running at a pace that challenges you.',
  'Stationary Bike': '30-45 minutes of cycling at a moderate to high intensity, adjusting resistance as needed.',
  'Rowing Machine': '20-30 minutes of rowing at a moderate to vigorous pace, focusing on maintaining good form.',
  'Elliptical Trainer': '20-30 minutes of elliptical training at a moderate to high intensity, adjusting resistance as needed.',
...
class WorkoutDetailsScreen extends StatelessWidget {
  ...
  WorkoutDetailsScreen({required this.categoryName});
  ...
  List<String> getWorkoutItems() {
    ...
    switch (categoryName) {
      ...
      case 'ABS':
        return ['Crunches', 'Leg Raises', 'Russian Twists', 'Plank', 'Mountain Climber'];
      case 'Shoulder':
        return ['Dumbbells Press', 'Lateral Raises', 'Front Raises', 'Rear Delt Fly', 'Upright Rows'];
      case 'Biceps':
        return ['Barbell Curl', 'Dumbbell Curl', 'Hammer Curl', 'Preacher Curl', 'Incline Curl'];
      case 'Chest':
        return ['Incline Bench Press', 'Flat Bench Press', 'Decline Bench Press', 'Chest Dips', 'Fly Machine'];
      case 'Triceps':
        return ['Triceps Dips', 'Triceps PushDown', 'Close-Grip Bench Press', 'Skull Crushers', 'Overhead Dumbbell'];
      case 'Back':
        return ['Pull-ups', 'Lat Pulldowns', 'Bent Over Rows', 'Seated Cable Rows', 'Deadlifts'];
      case 'Cardio':
        return ['Treadmill Running', 'Stationary Bike', 'Rowing Machine', 'Elliptical Trainer',];
      case 'Leg':
        return ['Squats', 'Leg Press', 'Walking Lunges', 'Leg Curls', 'Deadlifts'];
      case 'Calf':
        return ['Standing Calf Raises', 'Seated Calf Raises', 'Calf Press', 'Box Jump'];
      default:
        return [];
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final int itemCount = workoutItems.length; // Get the count of workout items
...
class WorkoutItemContainer extends StatelessWidget {
  ...
  WorkoutItemContainer({required this.categoryName, required this.itemName});
...
class _VideoPlayerScreenState extends State<VideoPlayerScreen> {
  ...
  void skipBackward() {
    final position = _videoController.value.position - Duration(seconds: 10);
